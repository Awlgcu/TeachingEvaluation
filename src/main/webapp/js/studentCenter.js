    ...
    $.ajax({
        ...
        success: function(body) {
            if (body.message){
                ...
                document.getElementById("input5").value=body.classId;
            }
        }
    })
}
...
$("#l1").click(function (){
    ...
    input1.name = "snumber";
    input1.id="input1";
    // input1.value = sessionStorage.getItem('snumber');
    ...
    input2.name = "name";
    input2.id="input2";
    // input2.value = sessionStorage.getItem('name');
    ...
    input3.name = "gender";
    input3.id="input3";
    // input3.value = sessionStorage.getItem('gender');
    ...
    input4.name = "age";
    input4.id="input4";
    // input4.value = sessionStorage.getItem('age');
    ...
    // input5.value = sessionStorage.getItem('classId');
    ...
    tpform.addEventListener('submit', function (event){
        ...
        let dataString = "snumber="+snumber+"&"+"name="+name+"&"+"age="+age+"&"+"gender="+gender+"&"+"action=update";
        $.ajax({
            url: 'student',
            type: 'POST',
